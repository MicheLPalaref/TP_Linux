// DE10_Standard_Qsys_alt_vip_cl_mixer_0.v
...
`timescale 1 ps / 1 ps
module DE10_Standard_Qsys_alt_vip_cl_mixer_0 #(
	...
	wire          vib_cmd0_av_st_dout_valid;           // vib_cmd0:av_st_dout_valid -> mixer_core:av_st_din_valid_0
	wire   [55:0] vib_cmd0_av_st_dout_data;            // vib_cmd0:av_st_dout_data -> mixer_core:av_st_din_data_0
	wire          vib_cmd0_av_st_dout_ready;           // mixer_core:av_st_din_ready_0 -> vib_cmd0:av_st_dout_ready
	wire          vib_cmd0_av_st_dout_startofpacket;   // vib_cmd0:av_st_dout_startofpacket -> mixer_core:av_st_din_startofpacket_0
	wire          vib_cmd0_av_st_dout_endofpacket;     // vib_cmd0:av_st_dout_endofpacket -> mixer_core:av_st_din_endofpacket_0
	...
	wire          vib_cmd1_av_st_dout_valid;           // vib_cmd1:av_st_dout_valid -> mixer_core:av_st_din_valid_1
	wire   [55:0] vib_cmd1_av_st_dout_data;            // vib_cmd1:av_st_dout_data -> mixer_core:av_st_din_data_1
	wire          vib_cmd1_av_st_dout_ready;           // mixer_core:av_st_din_ready_1 -> vib_cmd1:av_st_dout_ready
	wire          vib_cmd1_av_st_dout_startofpacket;   // vib_cmd1:av_st_dout_startofpacket -> mixer_core:av_st_din_startofpacket_1
	wire          vib_cmd1_av_st_dout_endofpacket;     // vib_cmd1:av_st_dout_endofpacket -> mixer_core:av_st_din_endofpacket_1
	...
	alt_vip_mix_alg_core #(
		...
		.av_st_din_valid                ({vib_cmd1_av_st_dout_valid,vib_cmd0_av_st_dout_valid}),                 //      av_st_din_0.valid
		.av_st_din_startofpacket        ({vib_cmd1_av_st_dout_startofpacket,vib_cmd0_av_st_dout_startofpacket}), //                 .startofpacket
		.av_st_din_endofpacket          ({vib_cmd1_av_st_dout_endofpacket,vib_cmd0_av_st_dout_endofpacket}),     //                 .endofpacket
		.av_st_din_data                 ({vib_cmd1_av_st_dout_data[55:0],vib_cmd0_av_st_dout_data[55:0]}),       //                 .data
	...
	assign vib_cmd0_av_st_dout_ready = { mixer_core_av_st_din_ready[0] };

	assign vib_cmd1_av_st_dout_ready = { mixer_core_av_st_din_ready[1] };
