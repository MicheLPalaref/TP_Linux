...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../painter_qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is painter_qsys
SOPC_NAME := painter_qsys
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1483695250
SOPC_SYSID_FLAG += --timestamp=1483695250
ELF_PATCH_FLAG  += --timestamp 1483695250
