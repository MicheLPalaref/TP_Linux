// camera_qsys_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module camera_qsys_mm_interconnect_1 (
	...
	camera_qsys_mm_interconnect_1_router router (
	...
	camera_qsys_mm_interconnect_1_router router_001 (
	...
	camera_qsys_mm_interconnect_1_router_002 router_002 (
	...
	camera_qsys_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pll_sys_outclk2_clk),                                     //       clk.clk
		.reset              (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	camera_qsys_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (pll_sys_outclk2_clk),                                     //       clk.clk
		.reset              (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	camera_qsys_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll_sys_outclk2_clk),                                     //       clk.clk
		.reset               (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	camera_qsys_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (pll_sys_outclk2_clk),                                     //       clk.clk
		.reset              (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	camera_qsys_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pll_sys_outclk2_clk),                                     //       clk.clk
		.reset               (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	camera_qsys_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (pll_sys_outclk2_clk),                                     //       clk.clk
		.reset               (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	camera_qsys_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
