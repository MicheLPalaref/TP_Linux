	camera_qsys u0 (
		...
		.i2c_opencores_touch_export_scl_pad_io        (<connected-to-i2c_opencores_touch_export_scl_pad_io>),        //        i2c_opencores_touch_export.scl_pad_io
		.i2c_opencores_touch_export_sda_pad_io        (<connected-to-i2c_opencores_touch_export_sda_pad_io>),        //                                  .sda_pad_io
		...
		.terasic_camera_conduit_end_camera_d          (<connected-to-terasic_camera_conduit_end_camera_d>),          //        terasic_camera_conduit_end.camera_d
		.terasic_camera_conduit_end_camera_fval       (<connected-to-terasic_camera_conduit_end_camera_fval>),       //                                  .camera_fval
		.terasic_camera_conduit_end_camera_lval       (<connected-to-terasic_camera_conduit_end_camera_lval>),       //                                  .camera_lval
		.terasic_camera_conduit_end_camera_pixclk     (<connected-to-terasic_camera_conduit_end_camera_pixclk>),     //                                  .camera_pixclk
