...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../camera_qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is camera_qsys
SOPC_NAME := camera_qsys
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1484889952
SOPC_SYSID_FLAG += --timestamp=1484889952
ELF_PATCH_FLAG  += --timestamp 1484889952
