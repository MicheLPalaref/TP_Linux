	soc_system u0 (
		...
		.camera_pwdn_n_external_connection_export                     (<connected-to-camera_pwdn_n_external_connection_export>),                     //         camera_pwdn_n_external_connection.export
		...
		.i2c_opencores_light_export_scl_pad_io                        (<connected-to-i2c_opencores_light_export_scl_pad_io>),                        //                i2c_opencores_light_export.scl_pad_io
		.i2c_opencores_light_export_sda_pad_io                        (<connected-to-i2c_opencores_light_export_sda_pad_io>),                        //                                          .sda_pad_io
		...
		.spi_mpu_external_MISO                                        (<connected-to-spi_mpu_external_MISO>),                                        //                          spi_mpu_external.MISO
		.spi_mpu_external_MOSI                                        (<connected-to-spi_mpu_external_MOSI>),                                        //                                          .MOSI
		.spi_mpu_external_SCLK                                        (<connected-to-spi_mpu_external_SCLK>),                                        //                                          .SCLK
		.spi_mpu_external_SS_n                                        (<connected-to-spi_mpu_external_SS_n>),                                        //                                          .SS_n
		...
		.ts_i2c_export_scl_pad_io                                     (<connected-to-ts_i2c_export_scl_pad_io>),                                     //                             ts_i2c_export.scl_pad_io
		.ts_i2c_export_sda_pad_io                                     (<connected-to-ts_i2c_export_sda_pad_io>),                                     //                                          .sda_pad_io
		.ts_interrupt_external_connection_export                      (<connected-to-ts_interrupt_external_connection_export>),                      //          ts_interrupt_external_connection.export
		...
		.tv_decoder_camera_conduit_end_camera_d                       (<connected-to-tv_decoder_camera_conduit_end_camera_d>),                       //             tv_decoder_camera_conduit_end.camera_d
		.tv_decoder_camera_conduit_end_camera_fval                    (<connected-to-tv_decoder_camera_conduit_end_camera_fval>),                    //                                          .camera_fval
		.tv_decoder_camera_conduit_end_camera_lval                    (<connected-to-tv_decoder_camera_conduit_end_camera_lval>),                    //                                          .camera_lval
		.tv_decoder_camera_conduit_end_camera_pixclk                  (<connected-to-tv_decoder_camera_conduit_end_camera_pixclk>),                  //                                          .camera_pixclk
