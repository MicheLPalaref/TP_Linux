...
//	     {0x6c,0x3502, 0x60}, // exposure L
	     {0x6c,0x3500, 0x00}, // exposure HH, default 0x00
	     {0x6c,0x3501, 0x18}, // exposure H, default 0x02
	     {0x6c,0x3502, 0x00}, // exposure L, default 0x00

	     {0x6c,0x3503, 0x00}, // gain no delay, exposure no delay
	     {0x6c,0x3508, 0x02}, // gain H , default 0x00
	     {0x6c,0x3509, 0x00}, // gain L , default 0x80
...
//	     {0x6c,0x380f, 0x1E}, // VTS L
	     ...
	     {0x6c,0x5018, 0x10}, // Red MWB gain
	     {0x6c,0x501A, 0x0C}, // Green MWB gain
	     {0x6c,0x501C, 0x10}, // Blue MWB gain
...
//	    OV8865_write_cmos_sensor_8(0x0100, 0x00);
//
//		OV8865_write_cmos_sensor_8(0x3830, level*4);
//		OV8865_write_cmos_sensor_8(0x3836, level);
//
//	    usleep(10000);
//		OV8865_write_cmos_sensor_8(0x0100, 0x01);
//}
